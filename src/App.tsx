        ...
        <div className="mb-12 w-screen relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] py-4 bg-transparent">
          ...
          <div className="marquee-wrapper">
            <div className="marquee-scroll">
              {[
                { name: "PRIYA SINGH", title: "CORPORATE EXECUTIVE", earnings: "₹50L+", desc: "Clients now approach me for opportunities", image: "https://i.pravatar.cc/?img=1" },
                { name: "RAJESHWARI PATEL", title: "ENTREPRENEUR", earnings: "₹2.5L+/M", desc: "Image transformed, business doubled", image: "https://i.pravatar.cc/?img=5" },
                { name: "MEERA GUPTA", title: "CONSULTANT", earnings: "₹1.5L+/M", desc: "Authority status in my industry now", image: "https://i.pravatar.cc/?img=9" },
                { name: "DIVYA SHARMA", title: "FREELANCER", earnings: "₹3.2L+", desc: "Finally charging what I deserve", image: "https://i.pravatar.cc/?img=13" },
                { name: "ANJALI DESAI", title: "BUSINESS OWNER", earnings: "₹4L+/M", desc: "My presence attracts the right clients", image: "https://i.pravatar.cc/?img=20" },
                { name: "NEHA KAPOOR", title: "COACH", earnings: "₹2.8L+/M", desc: "Brand positioning completely changed", image: "https://i.pravatar.cc/?img=28" },
                { name: "PRIYA SINGH", title: "CORPORATE EXECUTIVE", earnings: "₹50L+", desc: "Clients now approach me for opportunities", image: "https://i.pravatar.cc/?img=1" },
                { name: "RAJESHWARI PATEL", title: "ENTREPRENEUR", earnings: "₹2.5L+/M", desc: "Image transformed, business doubled", image: "https://i.pravatar.cc/?img=5" },
                { name: "MEERA GUPTA", title: "CONSULTANT", earnings: "₹1.5L+/M", desc: "Authority status in my industry now", image: "https://i.pravatar.cc/?img=9" },
